...
// User roles enum
export const userRoles = ["shipper", "carrier", "admin", "driver"] as const;
...
export const indianTruckTypes = [
  // ---------------- OPEN BODY ----------------
  { value: "Open 17 Feet", label: "Open - 17 Feet", category: "open", capacityMin: 6, capacityMax: 9 },
  { value: "Open 19 Feet", label: "Open - 19 Feet", category: "open", capacityMin: 7, capacityMax: 12 },
  { value: "Open 20 Feet", label: "Open - 20 Feet", category: "open", capacityMin: 9, capacityMax: 14 },
  { value: "Open 22 Feet", label: "Open - 22 Feet", category: "open", capacityMin: 10, capacityMax: 18 },
  { value: "Open 24 Feet", label: "Open - 24 Feet", category: "open", capacityMin: 14, capacityMax: 20 },
  { value: "Open 10 Wheeler", label: "Open - 10 Wheeler", category: "open", capacityMin: 16, capacityMax: 20 },
  { value: "Open 12 Wheeler", label: "Open - 12 Wheeler", category: "open", capacityMin: 20, capacityMax: 25 },
  { value: "Open 14 Wheeler", label: "Open - 14 Wheeler", category: "open", capacityMin: 25, capacityMax: 31 },
  { value: "Open 16 Wheeler", label: "Open - 16 Wheeler", category: "open", capacityMin: 28, capacityMax: 35 },
  { value: "Open 18 Wheeler", label: "Open - 18 Wheeler", category: "open", capacityMin: 32, capacityMax: 40 },

  // ---------------- CLOSED BODY ----------------
  { value: "Closed 17 Feet", label: "Closed Body - 17 Feet", category: "closed", capacityMin: 4, capacityMax: 7 },
  { value: "Closed 19 Feet", label: "Closed Body - 19 Feet", category: "closed", capacityMin: 5, capacityMax: 9 },
  { value: "Closed 20 Feet", label: "Closed Body - 20 Feet", category: "closed", capacityMin: 7, capacityMax: 12 },
  { value: "Closed 22 Feet", label: "Closed Body - 22 Feet", category: "closed", capacityMin: 9, capacityMax: 16 },
  { value: "Closed 24 Feet", label: "Closed Body - 24 Feet", category: "closed", capacityMin: 12, capacityMax: 18 },
  { value: "Closed 32 Feet", label: "Closed Body - 32 Feet", category: "closed", capacityMin: 15, capacityMax: 24 },

  // ---------------- CONTAINER ----------------
  { value: "Container 20ft", label: "Container - 20 Ft", category: "container", capacityMin: 7, capacityMax: 18 },
  { value: "Container 32ft", label: "Container - 32 Ft", category: "container", capacityMin: 14, capacityMax: 25 },
  { value: "Container 40ft", label: "Container - 40 Ft", category: "container", capacityMin: 20, capacityMax: 28 },

  // ---------------- LCV ----------------
  { value: "LCV Tata Ace", label: "LCV - Tata Ace", category: "lcv", capacityMin: 0.75, capacityMax: 1 },
  { value: "LCV Bolero", label: "LCV - Bolero Pickup", category: "lcv", capacityMin: 1, capacityMax: 1.7 },
  { value: "LCV 14ft", label: "LCV - 14 Feet", category: "lcv", capacityMin: 2.5, capacityMax: 4 },
  { value: "LCV 17ft", label: "LCV - 17 Feet", category: "lcv", capacityMin: 4, capacityMax: 6.5 },

  // ---------------- MINI PICKUP ----------------
  { value: "Mini Pickup", label: "Mini/Pickup", category: "mini_pickup", capacityMin: 0.5, capacityMax: 2 },

  // ---------------- TRAILER ----------------
  { value: "Trailer 40ft", label: "Trailer - 40 Ft", category: "trailer", capacityMin: 25, capacityMax: 34 },
  { value: "Trailer Triple Axle", label: "Trailer - Triple Axle", category: "trailer", capacityMin: 30, capacityMax: 40 },

  // ---------------- TIPPER ----------------
  { value: "Tipper 10 Wheel", label: "Tipper - 10 Wheeler", category: "tipper", capacityMin: 16, capacityMax: 21 },
  { value: "Tipper 12 Wheel", label: "Tipper - 12 Wheeler", category: "tipper", capacityMin: 20, capacityMax: 28 },

  // ---------------- TANKER ----------------
  { value: "Tanker Oil", label: "Tanker - Oil/Fuel", category: "tanker", capacityMin: 10, capacityMax: 24 },
  { value: "Tanker Water", label: "Tanker - Water", category: "tanker", capacityMin: 8, capacityMax: 20 },
  { value: "Tanker Chemical", label: "Tanker - Chemical", category: "tanker", capacityMin: 12, capacityMax: 35 },

  // ---------------- DUMPER ----------------
  { value: "Dumper Hyva", label: "Dumper - Hyva", category: "dumper", capacityMin: 16, capacityMax: 25 },
  { value: "Dumper 10 Wheel", label: "Dumper - 10 Wheeler", category: "dumper", capacityMin: 20, capacityMax: 35 },

  // ---------------- BULKER ----------------
  { value: "Bulker Cement", label: "Bulker - Cement", category: "bulker", capacityMin: 25, capacityMax: 35 },
  { value: "Bulker Fly Ash", label: "Bulker - Fly Ash", category: "bulker", capacityMin: 20, capacityMax: 36 },
] as const;
...
export const users = pgTable("users", {
  ...
  /** NULL = full admin; set = role-based admin with page restrictions */
  adminRoleId: varchar("admin_role_id"),
});

// Admin roles for role-based admin page access
export const adminRoles = pgTable("admin_roles", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  name: text("name").notNull().unique(),
  description: text("description"),
  pageKeys: text("page_keys").array().notNull().default(sql`'{}'::text[]`),
...
// Drivers table (for enterprise carriers and admin-provisioned accounts)
...
export const loads = pgTable("loads", {
  ...
  // IntuTrack trip tracking (set when start trip succeeds)
  triptrackId: text("triptrack_id"), // IntuTrack tripId from successful start trip
  triptrackMap: text("triptrack_map"), // Public map URL for this trip
...
export const shipments = pgTable("shipments", {
  ...
  physicalPodSubmittedAt: timestamp("physical_pod_submitted_at"),
  intutrackTripId: text("intutrack_trip_id"), // Set when IntuTrack POST /trips/start returns 200 (after Route Start OTP verified)
  intutrackTrackerLink: text("intutrack_tracker_link"), // Public tracking link from generatepubliclink, sent to shipper via SMS
});
...
export const financeReviews = pgTable("finance_reviews", {
  ...
  advancePaymentReleasedAt: timestamp("advance_payment_released_at"),
  advancePaymentReleasedBy: varchar("advance_payment_released_by").references(() => users.id),
  reviewedAt: timestamp("reviewed_at"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const financeReviewsRelations = relations(financeReviews, ({ one }) => ({
  ...
  advanceReleasedBy: one(users, {
    fields: [financeReviews.advancePaymentReleasedBy],
    references: [users.id],
  }),
}));
